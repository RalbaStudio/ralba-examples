...
type TemplateEditType = {
  name: string;
}[];

export interface TemplateEditPageState {
  data: TemplateEditType | null;
  loading: boolean;
}

@Injectable()
export class TemplateEditPageStore extends ComponentStore<TemplateEditPageState> {
