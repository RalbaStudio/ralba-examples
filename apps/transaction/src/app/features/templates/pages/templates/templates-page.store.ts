...
export interface TemplatesPageState {
  data: TemplatesType | null;
  loading: boolean;
}

@Injectable()
export class TemplatesPageStore extends ComponentStore<TemplatesPageState> {
  ...
  private readonly updateData = this.updater((state, input: TemplatesType) => ({
    ...state,
    data: input,
  }));
