...
export interface ItemCreatePageState {
  data: ItemCreateType | null;
  loading: boolean;
}

@Injectable()
export class ItemCreatePageStore extends ComponentStore<ItemCreatePageState> {
