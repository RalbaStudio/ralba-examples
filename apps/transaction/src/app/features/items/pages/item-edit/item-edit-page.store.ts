...
export interface ItemEditPageState {
  data: ItemEditType | null;
  loading: boolean;
}

@Injectable()
export class ItemEditPageStore extends ComponentStore<ItemEditPageState> {
  ...
  private readonly updateData = this.updater((state, input: ItemEditType) => ({
    ...state,
    data: input,
  }));
